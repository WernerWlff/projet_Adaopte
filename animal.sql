...
INSERT INTO animal (name, age, breed, type, city, zipcode, description, imageUrl) VALUES
  ...
  (
    ...
    "/images/chan-swan-NKyl19P5IHg-unsplash.jpg"
  ),
  (
    "Rex",
    "4 ans",
    ...
    "/images/alan-king-KZv7w34tluA-unsplash.jpg"
  ),
  (
    "Luna",
    "3 ans",
    ...
    "/images/jae-park-7GX5aICb5i4-unsplash.jpg"
  ),
  (
    "Biscuit",
    "3 mois",
    ...
    "/images/yosei-g-OVgE3m4MHKM-unsplash.jpg"
  ),
  (
    "Rio",
    "5 mois",
    ...
    "/images/melanie-kreutz-IFnknR2Mv5o-unsplash.jpg"
  ),
  (
    "Ruby",
    "2 ans",
    ...
    "/images/peri-stojnic-5Vr_RVPfbMI-unsplash.jpg"
  );
